...
if(isset($_SESSION['success_insert'])){
    ?>
        <script>
            alert("<?php echo $_SESSION['success_insert']?>");
        </script>
                ...
                <div class="carousel-item active">
                    <div class="container ">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="img-box">
                                    <img src="front_end/images/slider-img.png" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-fluid  ">
        <div class="row">
            ...
            <div class="col-md-6 px-0">
                <div class="img-box">
                    <img src="front_end/images/about-img.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="box ">
                    <div class="img-box">
                        <img src="front_end/images/w1.png" alt="">
                    </div>
                    <div class="detail-box">
                        <h5>
                            Fast Delivery
            ...
            <div class="col-md-4">
                <div class="box ">
                    <div class="img-box">
                        <img src="front_end/images/w2.png" alt="">
                    </div>
                    <div class="detail-box">
                        <h5>
                            Free Shiping
            ...
            <div class="col-md-4">
                <div class="box ">
                    <div class="img-box">
                        <img src="front_end/images/w3.png" alt="">
                    </div>
                    <div class="detail-box">
                        <h5>
                            Best Quality
...
<?php
require ('front_end/layouts/footer.php');